        ...
        <div className="container"> 
            ...
            <form className="col-lg-8 offset-lg-4">
                ...
                <div className="col-lg-9.5 offset-lg-1">
                    <button onClick={(e) => authorization(e)} className="btn btn-success col-lg-2 offset-lg-0">Log In</button>
                </div>
                <div className="col-lg-10 offset-lg-1">
                <Link className="col-lg-2 offset-lg-0" to="/register">Register</Link>
                </div>
            </form>
